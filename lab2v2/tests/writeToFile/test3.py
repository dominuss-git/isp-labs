...
print("YAML write test")

try:
  test = None
  serializer.serialize(test, format="YAML", file_path='/home/dominuss/labs/lab2v2/tests/writeToFile/out/testyaml.yaml')
  d = deserializer.deserialize('/home/dominuss/labs/lab2v2/tests/writeToFile/out/testyaml.yaml', format="YAML", normalize=True, file_mode=True)
