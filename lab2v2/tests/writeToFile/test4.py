...
print("PICKLE write test")

try:
  test = None
  serializer.serialize(test, format="PICKLE", file_path='/home/dominuss/labs/lab2v2/tests/writeToFile/out/testpickle.pickle')
  d = deserializer.deserialize('/home/dominuss/labs/lab2v2/tests/writeToFile/out/testpickle.pickle', format="PICKLE", normalize=True, file_mode=True)
